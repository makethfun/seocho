...
function f1(x,y) {
  ...
  { 
    ...
    function f2(t) { console.log(t, 'nested', xx, zz, lll); }  // hoisting은 undefined로?! // lll은 TDZ로 지워야 실행됨
    let lll = 0;   // hoisting되는 이유는 뒤에서 선언했는지 여부를 개발자에게 알려줘야 중복 선언 안함! // TDZ
...
f1(1,2);   console.log(kk, yy);  // ? yy is not defined in global scope // yy를 지워야함
